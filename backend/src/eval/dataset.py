...
SEED_CASES = [
    ...
    },
    {
        ...
        "expected": "Dense retrieval uses vector embeddings; sparse uses keyword matching like BM25",  # noqa: E501
        "category": "factual",
    },
    {
        "query": "What is LangGraph used for?",
        "expected": "LangGraph is a library for building stateful, multi-step LLM applications as graphs",  # noqa: E501
        "category": "factual",
    },
    {
    ...
    },
    {
        ...
        "expected": "A vector database stores and retrieves high-dimensional vectors for similarity search",  # noqa: E501
        "category": "factual",
    },
    {
    ...
    },
    {
        ...
        "expected": "Embeddings convert text into dense numerical vectors capturing semantic meaning",  # noqa: E501
        "category": "factual",
    },
    {
    ...
    },
    {
        ...
        "expected": "Quantization reduces model weight precision to decrease memory usage and increase speed",  # noqa: E501
        "category": "factual",
    },
    {
    ...
    },
    {
        ...
        "expected": "Grafana is an open-source platform for monitoring and observability dashboards",  # noqa: E501
        "category": "factual",
    },
    # ── Reasoning ─────────────────────────────────────────────────────────────
    {
        "query": "Why use hybrid search instead of dense-only retrieval?",
        "expected": "Hybrid search combines semantic and keyword matching for better coverage of both meaning and exact terms",  # noqa: E501
        "category": "reasoning",
    },
    {
        "query": "Why run LLMs locally instead of using cloud APIs?",
        "expected": "Local LLMs offer privacy, no API costs, no latency from network, and full control",  # noqa: E501
        "category": "reasoning",
    },
    {
        "query": "What are the tradeoffs of chunking documents into smaller pieces?",
        "expected": "Smaller chunks improve precision but lose context; larger chunks keep context but reduce precision",  # noqa: E501
        "category": "reasoning",
    },
    {
        "query": "Why use StatefulSet instead of Deployment for databases in Kubernetes?",
        "expected": "StatefulSet provides stable network identity and persistent storage order, essential for databases",  # noqa: E501
        "category": "reasoning",
    },
    {
        "query": "Why is temperature set lower for code generation?",
        "expected": "Lower temperature makes output more deterministic, reducing random syntax errors in generated code",  # noqa: E501
        "category": "reasoning",
    },
    {
        "query": "What are the benefits of using LangGraph over simple LLM chains?",
        "expected": "LangGraph enables stateful multi-step workflows with branching, loops, and conditional logic",  # noqa: E501
        "category": "reasoning",
    },
    {
        "query": "Why use RRF (Reciprocal Rank Fusion) for combining search results?",
        "expected": "RRF combines rankings from multiple sources without requiring score normalization",  # noqa: E501
        "category": "reasoning",
    },
    {
        "query": "When should you use streaming responses vs. batch responses?",
        "expected": "Streaming provides faster time-to-first-token UX; batch is simpler for programmatic use",  # noqa: E501
        "category": "reasoning",
    },
    {
        "query": "Why use pydantic-settings for configuration instead of os.environ?",
        "expected": "pydantic-settings provides type validation, default values, and structured config objects",  # noqa: E501
        "category": "reasoning",
    },
    {
        "query": "What is the purpose of the reviewer node in the agent graph?",
        "expected": "The reviewer evaluates output quality and decides whether to accept or retry with more research",  # noqa: E501
        "category": "reasoning",
    },
    {
        "query": "Why use nomic-embed-text for embeddings instead of OpenAI embeddings?",
        "expected": "nomic-embed-text runs locally with no API costs and produces 768-dim vectors suitable for semantic search",  # noqa: E501
        "category": "reasoning",
    },
    {
        "query": "What is the advantage of using SSE over WebSockets for streaming chat?",
        "expected": "SSE is simpler (HTTP), unidirectional, automatic reconnect, works through proxies; WebSocket needed for bi-directional",  # noqa: E501
        "category": "reasoning",
    },
    {
        "query": "Why use structlog instead of Python's built-in logging?",
        "expected": "structlog provides structured JSON logging with context binding, better for observability pipelines",  # noqa: E501
        "category": "reasoning",
    },
    {
        "query": "What is the benefit of LLM-as-judge for evaluation?",
        "expected": "LLM-as-judge scales evaluation without expensive human annotation, though it has its own biases",  # noqa: E501
        "category": "reasoning",
    },
    {
        "query": "Why store eval results in SQLite instead of a file?",
        "expected": "SQLite enables querying, filtering by date/category, and tracking metrics over time without a separate DB server",  # noqa: E501
        "category": "reasoning",
    },
    # ── Code ──────────────────────────────────────────────────────────────────
    {
    ...
    },
    {
        ...
        "expected": "async def fetch_json(url): async with httpx.AsyncClient() as c: r = await c.get(url); return r.json()",  # noqa: E501
        "category": "code",
    },
    {
        "query": "Write a Python context manager that measures execution time",
        "expected": "import time; class Timer: def __enter__(self): self.start=time.perf_counter(); return self; def __exit__(self,...): self.elapsed=time.perf_counter()-self.start",  # noqa: E501
        "category": "code",
    },
    {
    ...
    },
    {
        ...
        "expected": "def retry(fn): def wrapper(*a,**k): for i in range(3):\\n    try: return fn(*a,**k)\\n    except Exception: if i==2: raise; return wrapper",  # noqa: E501
        "category": "code",
    },
    {
        "query": "Write a Python dataclass for a document with title, content, and metadata fields",
        "expected": "@dataclass class Document: title: str; content: str; metadata: dict = field(default_factory=dict)",  # noqa: E501
        "category": "code",
    },
    {
        "query": "Write a Python function to flatten a nested list",
        "expected": "def flatten(lst): return [x for sub in lst for x in (flatten(sub) if isinstance(sub, list) else [sub])]",  # noqa: E501
        "category": "code",
    },
    {
    ...
    },
    {
        ...
        "expected": "@app.get('/items') async def list_items() -> list[dict]: return [{'id': 1, 'name': 'item'}]",  # noqa: E501
        "category": "code",
    },
    {
        "query": "Write Python code to compute cosine similarity between two vectors",
        "expected": "import numpy as np; def cosine_sim(a, b): return np.dot(a,b)/(np.linalg.norm(a)*np.linalg.norm(b))",  # noqa: E501
        "category": "code",
    },
    {
    ...
    },
    {
        ...
        "expected": "import argparse; p = argparse.ArgumentParser(); p.add_argument('--input'); args = p.parse_args()",  # noqa: E501
        "category": "code",
    },
    # ── Mixed / Edge cases ────────────────────────────────────────────────────
    {"query": "What is 2 to the power of 10?", "expected": "1024", "category": "factual"},
    {"query": "What is the capital of France?", "expected": "Paris", "category": "factual"},
    {
    ...
    },
    {
        ...
        "expected": "Docker packages applications and dependencies into containers for consistent, portable deployment",  # noqa: E501
        "category": "factual",
    },
    {
    ...
    },
    {
        ...
        "expected": "p99 latency is the 99th percentile response time — 99% of requests complete within this duration",  # noqa: E501
        "category": "factual",
    },
    {
    ...
    },
    {
        ...
        "expected": "Async uses an event loop for non-blocking I/O; sync blocks execution until each operation completes",  # noqa: E501
        "category": "reasoning",
    },
]
